...
|---|---:|---:|---:|---:|---:|---:|---:|
| **L3 blend (ours)** | 1585 | 69.21 | 13.019 | 16.549 | 0.1968 | 0.5765 | 9.17 pp |
| **L2 results core (ours)** | 1585 | 69.40 | 13.207 | 16.696 | 0.1978 | 0.5830 | 7.27 pp |
| **L1 efficiency (ours)** | 1585 | 70.03 | 13.158 | 16.678 | 0.1992 | 0.5823 | 8.30 pp |
...
| System | n | SU % | MAE | RMSE | Brier | Log loss | Max calib. dev. |
|---|---:|---:|---:|---:|---:|---:|---:|
| **L3 blend (ours)** | 2061 | 67.98 | 13.725 | 17.474 | 0.2045 | 0.6022 | 11.40 pp |
| **L2 results core (ours)** | 2061 | 68.41 | 13.878 | 17.591 | 0.2056 | 0.6091 | 10.45 pp |
| **L1 efficiency (ours)** | 2061 | 69.09 | 13.914 | 17.543 | 0.2059 | 0.6061 | 8.97 pp |
...
| Max decile calibration deviation | <= 5.0 pp | 9.17 pp | **FAIL** |
...
```json
{
  ...
  "observed": {
    ...
    "max_calibration_deviation_pp": 9.173719881042006,
...
| Brier | 0.1978 | 0.1968 | **-0.0010** better |
| Log loss | 0.5830 | 0.5765 | **-0.0064** better |
| Violations | 0.2166 | 0.2276 | **+0.0111** better |
| Straight-up % | 69.40 | 69.21 | -0.19 pp (-3 games) |
| Max calibration dev. | 7.27 pp | 9.17 pp | +1.90 pp |
