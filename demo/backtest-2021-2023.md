...
| Violations | 0.2107 | 0.2071 | **-0.0036** better |
...
|---|---:|---:|---:|
| **Schedule odds (the headline)** | 0.1995 | 442 / 2216 | 9.66 |
| **L4 résumé (ours)** | 0.1936 | 429 / 2216 | 9.30 |
| **L3 blend (ours)** | 0.2071 | 459 / 2216 | 8.28 |
| **L2 results core (ours)** | 0.2107 | 467 / 2216 | 8.06 |
| **L1 efficiency (ours)** | 0.2347 | 520 / 2216 | 7.97 |
...
building them.** The headline is at 0.1995 and the résumé at 0.1936, against L3's
0.2071, L2's 0.2107, SRS's 0.2153 and Elo's 0.2243. A margin-based rating is not
...
none of them is a power rating:** win percentage (0.1769), Colley (0.1963) and the
random walker (0.1977). All three are margin-blind and two of the three ignore
...
(`violations_must_beat`). Colley is at 0.1963. Schedule odds is at
0.1995, so the harness reports that criterion as `False` — and the ordering it
replaced, at 0.1936, reports `True`. **That is a real cost of
...
**Neither beats win percentage, which is at 0.1769, and that is worth
