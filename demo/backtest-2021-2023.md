...
is at 0.1936 against Colley's 0.1963 and SRS's 0.2153, and the harness now
reports that criterion as `True` rather than as an undecided null. It also beats
its own Power rating by 1.35 points of violation rate, which is the point of building the layer.
...
On the pooled 2021-2023 number the résumé and Colley are exactly tied (429 each,
