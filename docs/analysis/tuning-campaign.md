...
The decile table at the FITTED ν = 92.73 — the value the protocol declared, against the incumbent normal's table in §5.0:

| Predicted decile | n | Mean predicted | Observed | Deviation |
|---|---:|---:|---:|---:|
| 0.0–0.1 *(uncounted)* | 6 | 0.068 | 0.000 | -6.81 pp |
| 0.1–0.2 | 38 | 0.164 | 0.053 | -11.17 pp |
| 0.2–0.3 | 86 | 0.250 | 0.151 | -9.88 pp |
| 0.3–0.4 | 173 | 0.351 | 0.249 | -10.22 pp |
| 0.4–0.5 | 231 | 0.453 | 0.450 | -0.32 pp |
| 0.5–0.6 | 328 | 0.551 | 0.552 | +0.10 pp |
| 0.6–0.7 | 329 | 0.645 | 0.675 | +3.02 pp |
| 0.7–0.8 | 231 | 0.747 | 0.792 | +4.56 pp |
| 0.8–0.9 | 128 | 0.840 | 0.828 | -1.21 pp |
| 0.9–1.0 | 35 | 0.931 | 0.943 | +1.18 pp |
...
| Predicted decile | n | Mean predicted | Observed | Deviation |
|---|---:|---:|---:|---:|
| 0.0–0.1 *(uncounted)* | 4 | 0.085 | 0.000 | -8.51 pp |
| 0.1–0.2 | 26 | 0.169 | 0.000 | -16.90 pp |
| 0.2–0.3 | 103 | 0.253 | 0.165 | -8.76 pp |
| 0.3–0.4 | 177 | 0.351 | 0.237 | -11.34 pp |
| 0.4–0.5 | 224 | 0.451 | 0.460 | +0.83 pp |
| 0.5–0.6 | 309 | 0.552 | 0.544 | -0.81 pp |
| 0.6–0.7 | 353 | 0.646 | 0.671 | +2.52 pp |
| 0.7–0.8 | 264 | 0.747 | 0.788 | +4.10 pp |
| 0.8–0.9 | 109 | 0.837 | 0.881 | +4.38 pp |
| 0.9–1.0 *(uncounted)* | 16 | 0.915 | 1.000 | +8.45 pp |
...
*Generated by `scripts/tuning_campaign.py` at commit `fbc88c8eaf`; every number above is in `tuning-campaign.json`. Config hash `bd6a19c152f0222c` — the file as it stands NOW, carrying the frozen choice; the search cells were produced by explicit overrides on it rather than by editing it. Holdout touched: false.*
