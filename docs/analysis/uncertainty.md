...
σ = 15.3, seed 20260812, λ = 0.5. These are the numbers that
...
|---|---:|---:|---|---:|---:|
| Ohio State | 1 | 4 | **#1 – #25** | 0.73 | 0.96 |
| Washington | 2 | 16 | **#2 – #55** | 0.37 | 0.72 |
| Florida State | 3 | 11 | **#2 – #46** | 0.49 | 0.79 |
| Alabama | 5 | 20 | **#2 – #59** | 0.26 | 0.67 |
| James Madison | 4 | 25 | **#3 – #66** | 0.18 | 0.54 |
| Georgia | 6 | 13 | **#2 – #49** | 0.35 | 0.73 |
| Michigan | 9 | 7 | **#3 – #23** | 0.69 | 0.96 |
| Liberty | 12 | 23 | **#6 – #66** | 0.20 | 0.55 |
| Tulane | 17 | 42 | **#9 – #89** | 0.08 | 0.29 |

The median 90% interval width across all 133 ranked teams is **82 places**.
...
review's Phase 1 predicted 2 to 2.5×, measured 1.00×, and recorded its own
prediction as wrong. We reproduce 1.00×, on a different fit, with a different
penalty, on a different response.
...
Generated by `scripts/uncertainty_study.py` at 2026-08-12 - code `f1c76c4` - config sha256 `01c3ab291309b0be...`
